                ...
                if ext in videoFormats:
                    ...
                    if os.path.exists(thumb_image):
                        ...
                        try:
                            ...
                            genThumbCmd = "/usr/bin/ffmpeg -loglevel panic -i \"{0}\" -vframes 1 -an -vf scale=96:-1 -ss 0.1 -y \"{1}\"".format(file_path, thumb_image)
                ...
                if ext in imageFormats:
                    ...
                    if os.path.exists(thumb_image):
                        ...
                        try:
                            ...
                            # im.save(thumb_image)
                            genThumbCmd = "/usr/bin/convert \"{0}\" -sample 96x96 \"{1}\"".format(file_path, thumb_image)
                            subprocess.call(shlex.split(genThumbCmd))
                        except:
                            debug.info(str(sys.exc_info()))
