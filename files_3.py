...
class FSM(QtWidgets.QFileSystemModel):
    ...
    def get_icon(self, file_abs_path, file_type, file_name):
        ...
        #         if file_info.suffix() in mimeTypes["video"]:
        #             file_name = file_info.fileName()
        #             file_abs_path = file_info.filePath()
        #             debug.info(file_abs_path)
        #             try:
        #                 thumb_image = filesThumbsDir+thumbs[file_abs_path]+".jpeg"
        #                 if os.path.exists(thumb_image):
        #                     return QtGui.QIcon(thumb_image)
        #                 else:
        ...
        #                 debug.info(str(sys.exc_info()))
        #
        #         if file_info.suffix() in mimeTypes["audio"]:
        ...
        #
        #         if file_info.suffix() in mimeTypes["image"]:
        #             file_name = file_info.fileName()
        #             file_abs_path = file_info.filePath()
        #             debug.info(file_abs_path)
        #             try:
        ...
        #                 debug.info(str(sys.exc_info()))
        #
        #         if file_info.suffix() in mimeTypes["text"]:
...
#
#         ROOTDIRNEW = os.path.abspath(main_ui.currentFolderBox.text().strip())
...
#         main_ui.tabWidget.customContextMenuRequested.connect(self.popUpTabs)
#         # main_ui.connect(main_ui.tabWidget, SIGNAL('customContextMenuRequested(const QPoint &)'), self.popUpTabs)
#         main_ui.tabWidget.currentChanged.connect(self.current_tab_changed)
#         main_ui.tabWidget.tabCloseRequested.connect(self.close_current_tab)
#
#         main_ui.changeViewButt.setIcon(QtGui.QIcon(self.iconsIcon))
#         main_ui.previousDirButt.setIcon(QtGui.QIcon(self.prevDirIcon))
#         main_ui.changeDirButt.setIcon(QtGui.QIcon(self.goIcon))
#         main_ui.searchButt.setIcon(QtGui.QIcon(self.searchIcon))
#         main_ui.homeButt.setIcon(QtGui.QIcon(self.homeIcon))
#         main_ui.themeButt.setIcon(QtGui.QIcon(self.lightIcon))
#
#         main_ui.currentFolderBox.findChild(QtWidgets.QToolButton).setIcon(QtGui.QIcon(self.clearIcon))
#         main_ui.searchBox.findChild(QtWidgets.QToolButton).setIcon(QtGui.QIcon(self.clearIcon))
#
#         # self.changeViewSc = QShortcut(QKeySequence("Ctrl+V"), self)
#         # self.changeViewSc.activated.connect(self.changeView)
#         QShortcut(QKeySequence("Ctrl+T"),main_ui).activated.connect(self.tab_open_doubleclick)
#         # QShortcut(QKeySequence("Ctrl+W"),main_ui).activated.connect(lambda currTabIndex = main_ui.tabWidget.currentIndex() :self.close_current_tab(currTabIndex))
...
#         main_ui.homeButt.clicked.connect(self.goHome)
#         main_ui.searchBox.textChanged.connect(lambda x : self.search())
#         main_ui.changeViewButt.clicked.connect(lambda x : self.changeView())
#         main_ui.previousDirButt.clicked.connect(lambda x: self.previousDir())
#         main_ui.changeDirButt.clicked.connect(lambda x: self.changeDir())
#         main_ui.searchButt.clicked.connect(lambda x: self.search())
#
#         main_ui.audioRestartButt.clicked.connect(lambda x: self.audioRestart())
#         main_ui.fixPenDisplayButt.clicked.connect(lambda x: self.fixPenDisplay())
#         main_ui.blenderMediaViewerButt.clicked.connect(lambda x: self.blenderMediaViewer())
#         main_ui.downloadButt.clicked.connect(lambda x: self.downloadVideo())
#         main_ui.cancelButt.clicked.connect(lambda x: self.cancelVideoDownload())
#
#         try:
